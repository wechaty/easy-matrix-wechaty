...
docker-compose run --rm --entrypoint sh synapse -c "echo \"domain: $HOST
homeserverUrl: http://synapse:8008
...
docker-compose run --rm --entrypoint sed synapse -e 's/#app_service_config_files/app_service_config_files/' -e '/app_service_config_files/a\  - \/data\/wechaty-registration.yaml' -i /data/homeserver.yaml
